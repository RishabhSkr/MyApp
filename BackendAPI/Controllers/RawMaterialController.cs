...
namespace BackendAPI.Controllers
{
    ...
    public class RawMaterialController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateRawMaterial(int id, [FromBody] RawMaterialUpdateDto dto)
        {
            int userId = 1; // TODO: JWT
            var result = await _service.UpdateRawMaterialAsync(id, dto, userId);
